    ...
    <div class="">
        <table class="table table-striped" style="background-color: #FFF;">
            ...
            <?php
                ...
                if($busca != "CLI_ID" && $busca != "CLI_NOME" && $busca != "CLI_EMAIL" && $busca != "CLI_NASCIMENTO"){
                    $type = "<=";
            ...
            ?>
                <tr>
                    ...
                    <td scope="row"><a href="detalhecliente.php?id=<?php echo $linha['CLI_ID'];?>"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16"><path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/></svg></a></td>
                    <td scope="row"><a href="cadcliente.php?id=<?php echo $linha['CLI_ID'];?>&comando=update"><img src="../img/history-solid.svg" style="width: 2rem;"></a></td>
